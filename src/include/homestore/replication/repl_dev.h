...
VENUM(journal_type_t, uint16_t,
      ...
      HS_CTRL_REPLACE_START = 3,    // Control message to start replace a member
      HS_CTRL_REPLACE_COMPLETE = 4, // Control message to complete replace a member
)
